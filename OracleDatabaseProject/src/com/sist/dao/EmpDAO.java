 ...
 * 		==> Class.forName("드라이버") => 한 번만 설정 (생성자)
 *  2. 데이터베이스 연결
 *  	==> Connection
 *  3. 데이터베이스 해제
 *  4. ***SQL문장 제작
...
public class EmpDAO {
	// 1. 공통 사용된 객체
	private Connection conn; // 오라클을 연결하는 객체
	// => 인터페이스 (모든 데이터와 연결 가능)
	// SQL문장 ANSI (표준화)
